...
mysqldb=mysql.connector.connect(host="127.0.0.1",user="adil",password="adil1234")#established connection  
...
TRAIN_UPLOAD_FOLDER='//home//adil//train_data';
...
def fetch_data():
    ...
    print(request.form.to_dict()["adil"]);
...
def fileUploading():
 ...
 #   filess={'file':open('C:\\Users\\Adil_\\Downloads\\en.pdf','rb')};
